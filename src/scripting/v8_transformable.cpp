...
#define DEFINE_HANDLE_SCOPE_AND_GET_SELF_FOR_TRANSFORMABLE 	HandleScope handle_scope(info.GetIsolate()); \
	Transformable * self = GetSelf<CommonDrwableStyle>(info.This());
