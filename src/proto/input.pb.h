...
inline ::google::protobuf::uint32 Input::pid() const {
  // @@protoc_insertion_point(field_get:Input.pid)
  return pid_;
}
inline void Input::set_pid(::google::protobuf::uint32 value) {
  set_has_pid();
  pid_ = value;
  // @@protoc_insertion_point(field_set:Input.pid)
}
...
inline const ::Vector2d& Input::pos() const {
  // @@protoc_insertion_point(field_get:Input.pos)
  return pos_ != NULL ? *pos_ : *default_instance_->pos_;
}
inline ::Vector2d* Input::mutable_pos() {
  set_has_pos();
  if (pos_ == NULL) pos_ = new ::Vector2d;
  // @@protoc_insertion_point(field_mutable:Input.pos)
  return pos_;
}
...
inline void Input::set_allocated_pos(::Vector2d* pos) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Input.pos)
}
...
inline ::google::protobuf::int32 Input::key() const {
  // @@protoc_insertion_point(field_get:Input.key)
  return key_;
}
inline void Input::set_key(::google::protobuf::int32 value) {
  set_has_key();
  key_ = value;
  // @@protoc_insertion_point(field_set:Input.key)
}
...
inline const ::std::string& Input::msg() const {
  // @@protoc_insertion_point(field_get:Input.msg)
  return *msg_;
}
inline void Input::set_msg(const ::std::string& value) {
  ...
  msg_->assign(value);
  // @@protoc_insertion_point(field_set:Input.msg)
}
inline void Input::set_msg(const char* value) {
  ...
  msg_->assign(value);
  // @@protoc_insertion_point(field_set_char:Input.msg)
}
inline void Input::set_msg(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Input.msg)
}
inline ::std::string* Input::mutable_msg() {
  ...
  // @@protoc_insertion_point(field_mutable:Input.msg)
  return msg_;
}
...
inline void Input::set_allocated_msg(::std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Input.msg)
}
