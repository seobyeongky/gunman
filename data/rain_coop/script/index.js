	...
	"rain_coop": {
		"src": {
			...
			"play.coffee": function (exports, module, require) {
				var ACID, BG_KIND, FRAME_RATE, INPUT_CHAT_MESSAGE, MAX_HP, POP, RANDOM, SEA_SEVERTY_LEVELS, STATE_READY, STATE_RESULT, SUCCEEDED, Scheduler, WORSE, dict, main_key_color, make_message_text, play_hit, play_miss, stages, sub_key_color, textures, the_seed, _, _i, _j, _ref, _results, _results1,
				  __slice = [].slice;
			...
			"ready.coffee": function (exports, module, require) {
				var BG_KIND, FOGHORN, MAX_NR_PLAYER, STATE_PLAY, Scheduler, make_bg, shuffle, _ref;
				...
				module.exports = function(env) {
				  var bg, count, lv, players, scheduler, text;
				  lv = env.lv;
				  players = Player.all();
				  ...
				  text.string = players.length === 1 ? "산성비를 막아라!" : "" + players.length + "인 협동 산성비 막기!!";
				  text.x = 0.3 * UI.width;
